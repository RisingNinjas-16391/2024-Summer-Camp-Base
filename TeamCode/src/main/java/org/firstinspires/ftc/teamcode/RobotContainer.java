...
public class RobotContainer {
  ...
  //  private final GamepadButton m_intakePosition;
    ...
    private void setAutoCommands(int chooser) {
        switch (chooser) {
            case 1:
                new BlueAutoCommand(m_driveSubsystem, m_clawSubsystem, m_pivotSubsystem).schedule();
                break;
            case 2:
                new RedAutoCommand(m_driveSubsystem, m_clawSubsystem,  m_pivotSubsystem).schedule();
                break;
        }
