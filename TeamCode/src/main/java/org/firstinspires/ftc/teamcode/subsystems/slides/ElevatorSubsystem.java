...
public class ElevatorSubsystem extends TrapezoidalSubsystemBase {
    ...
    private final PIDFController m_feedbackController = ElevatorConstraints.PIDF_CONTROLLER;
    private final BetterElevatorFeedForward m_feedforwardController = ElevatorConstraints.FEEDFORWARD_CONTROLLER;

    public ElevatorSubsystem(HardwareMap hardwareMap){
        super(ElevatorConstraints.TRAPEZOIDAL_CONSTRAINTS, ElevatorConstraints.ERROR_MARGIN);

        m_leftMotor = new Motor(hardwareMap, "left");
        m_rightMotor = new Motor(hardwareMap, "right");
    ...
    public void periodic(){
        ...
        m_feedbackController.setPIDF(ElevatorConstraints.kP, ElevatorConstraints.kI, ElevatorConstraints.kD, ElevatorConstraints.kF);
        m_feedforwardController.setGains(ElevatorConstraints.kS, ElevatorConstraints.kG, ElevatorConstraints.kV, ElevatorConstraints.kA);
    ...
    public boolean setGoal(double extension) {
        double adjustedExtension = MathUtil.clip(ElevatorConstraints.LOWER_BOUND, extension, ElevatorConstraints.UPPER_BOUND);
    ...
    public double getVelocity() {
        return m_leftMotor.getCorrectedVelocity() * ElevatorConstraints.CENTIMETERS_PER_TICK;
    }

    public double getExtensionMeters() {
        return m_leftMotor.getCurrentPosition() * ElevatorConstraints.CENTIMETERS_PER_TICK;
    }
